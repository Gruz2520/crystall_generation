...
model.save_pretrained("crystall_generation/models/fine_tuned_Llama-3.2-3b_bg_eform_slice")
tokenizer.save_pretrained("crystall_generation/models/fine_tuned_Llama-3.2-3b_bg_eform_slice")
...
model = AutoModelForCausalLM.from_pretrained("crystall_generation/models/fine_tuned_Llama-3.2-3b_bg_eform_slice")
tokenizer = AutoTokenizer.from_pretrained("crystall_generation/models/fine_tuned_Llama-3.2-3b_bg_eform_slice")

print("Start testing the model")

# Create a text generation pipeline
generator = pipeline("text-generation", model=model, tokenizer=tokenizer)
input_text = "band_gap=0.0 e_form=-0.772252"
